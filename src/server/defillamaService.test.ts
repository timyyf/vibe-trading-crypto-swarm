...
const protocols: DefiLlamaProtocol[] = [
  { name: 'Aave', tvl: 100, change_24h: 20, chains: ['Ethereum'], category: 'Lending' },
  { name: 'Curve', tvl: 50, change_1d: -30, chains: ['Ethereum', 'Polygon'], category: 'DEX' },
  { name: 'Uniswap', tvl: 200, change_24h: 5, chains: ['Ethereum'], category: 'DEX' },
  { name: 'Sem TVL', tvl: 0, change_24h: 10, chains: [], category: 'Outros' },
  { name: 'Sem variação', tvl: 300, chains: ['Ethereum'], category: 'Lending' },
];

describe('defillamaService - ranking de top movers', () => {
  it('ordena por variação absoluta e usa change_1d como fallback', () => {
  ...
  it('ignora protocolos sem TVL ou sem variação reportada', () => {
    const movers = rankDefiLlamaMovers(protocols, 8);
